        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="p-6 bg-primary rounded-2xl text-primary-foreground">
              <h3 className="font-display font-semibold text-lg mb-2">Need urgent support?</h3>
              <p className="text-primary-foreground/70 text-sm mb-4">Our team is available 24/7 for critical issues.</p>
              <a href="tel:+260977123456" className="inline-flex items-center gap-2 text-accent font-semibold text-sm group">
                Call Now
          ...
          <div className="lg:col-span-3">
            <form
              onSubmit={handleSubmit}
              className="bg-card rounded-3xl shadow-large p-8 lg:p-10 border border-border/50"
              noValidate
            >
              {isSuccess && (
                <div className="flex items-center gap-3 p-5 mb-8 bg-success/10 text-success rounded-xl border border-success/20">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className={`${inputClasses} ${errors.name ? "border-destructive ring-destructive/20" : "border-input"}`}
                    placeholder="John Doe"
                  />
                  {errors.name && (
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.email}
                    onChange={handleChange}
                    className={`${inputClasses} ${errors.email ? "border-destructive ring-destructive/20" : "border-input"}`}
                    placeholder="john@company.com"
                  />
                  {errors.email && (
                    <p className="mt-2 text-xs text-destructive flex items-center gap-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.phone}
                    onChange={handleChange}
                    className={`${inputClasses} ${errors.phone ? "border-destructive ring-destructive/20" : "border-input"}`}
                    placeholder="+260 977 123 456"
                  />
                  {errors.phone && (
                    <p className="mt-2 text-xs text-destructive flex items-center gap-1">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    value={formData.message}
                    onChange={handleChange}
                    className={`${inputClasses} resize-none ${errors.message ? "border-destructive ring-destructive/20" : "border-input"}`}
                    placeholder="Tell us about your project requirements..."
                  />
                  {errors.message && (
                    <p className="mt-2 text-xs text-destructive flex items-center gap-1">
              ...
              <Button
                ...
                variant="cta"
                size="lg"
                className="w-full mt-8 rounded-xl h-14"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
                  <>
